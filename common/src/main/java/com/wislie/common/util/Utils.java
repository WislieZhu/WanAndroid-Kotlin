...
public final class Utils {
     ...
     * 获取当前主题颜色
     */
    public static int getColor(Context context, int colorPrimary) {
        SharedPreferences setting = PreferenceManager.getDefaultSharedPreferences(context);
        int defaultColor = ContextCompat.getColor(context, colorPrimary);
    ...
    static class ActivityLifecycleImpl implements ActivityLifecycleCallbacks {
        ...
        public void onActivityCreated(@NonNull Activity activity, Bundle savedInstanceState) {
            ActivityManagerUtil.Companion.getInstance().addActivity(activity);
        ...
        public void onActivityDestroyed(@NonNull Activity activity) {
            ActivityManagerUtil.Companion.getInstance().finishActivity(activity);
